--exemple avec une classe et eleve

--on veut faire apparaitre dans la table de classe, la présence des eleves
...
--creer la ta table de jointure pour afficher un eleve en particulier et son sport, et aussi voir les multiple sport q'un seul eleve puisse faire
...
WHERE
    ...
    ( 'foot' ),( 'natation' ),( 'belote' ),( 'cyclisme' ),( 'tir sportif' ),( 'foot-ball americain' );
-------------